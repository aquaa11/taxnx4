...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <div 
        className={`lg:hidden fixed inset-0 pt-16 bg-gradient-to-b from-gray-900/95 to-gray-800/95 backdrop-blur-xl z-40 transition-all duration-300 ease-in-out ${
